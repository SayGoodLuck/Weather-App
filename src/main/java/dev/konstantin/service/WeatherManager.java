...
public class WeatherManager {
  ...
  public List<DailyForecast> getSevenDaysForecast(@NotNull String cityName) throws WeatherManagerException {
    ...
    if (output.isEmpty()) {
      throw new WeatherManagerException("output is null");
    }
    ...
    for (var index = 0; index < sevenDays.length(); index++) {
      ...
      var min = String.valueOf(sevenDays.getJSONObject(index).getJSONObject("temp").getInt("min"));
      var max = String.valueOf(sevenDays.getJSONObject(index).getJSONObject("temp").getInt("max"));
      var feelsLike =
          String.valueOf(sevenDays.getJSONObject(index).getJSONObject("feels_like").getInt("day"));
  ...
  public City getCityInfo(String cityName) throws WeatherManagerException {
    String output =
        getUrlContent(
    ...
    if (output.isEmpty()) {
      ...
      throw new WeatherManagerException("output is empty");
    }
    ...
    return new City(
        ...
        json.getJSONObject(0).getDouble("lon"),
        json.getJSONObject(0).getDouble("lat"),
  ...
  public String getImageUrl(String iconCode) {
